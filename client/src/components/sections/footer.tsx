...
export default function Footer() {
  return (
    <footer className="bg-slate-900 text-white section-spacing">
          ...
          <AnimatedSection>
            <div>
              ...
              <p className="text-slate-400 leading-relaxed mb-6">
                Transforming marketing with AI-powered tools that help businesses create,
                optimize, and scale their brand presence.
              </p>
